...
def main():
    """Takes and automatically crops a screenshot to capture the OSRS client
    window. Useful for running on demand manually."""
    os.chdir('/home/austin/OSRS-AHKScripts/python/tests')
    target_image = vis.Vision(needle='../main/needles/menu/prayers.png')
    target_image = target_image.mlocate(loctype='center')
